...
class APIServer:
    ...
    def make_app(self):
        ...
        (r"/api/devices/(?P<device_id>[^/]+)/type", DeviceTypeHandler, dict(db_manager=self.db_manager)),
        ...
        (r"/api/devices/(?P<device_id>[^/]+)", DeviceHandler, dict(db_manager=self.db_manager, get_tcp_server_func=self.get_tcp_server)),
